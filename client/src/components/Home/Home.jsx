              ...
              <div>
                ...
                {showOptions && (
                  <div className="dropdown">
                    ...
                    <button
                      className="logoutButton drop-btn"
          ...
          <div className="column">
            <div className="row">
              <div className="home_page_elements col-7">
                ...
                <p>
                  Discover the art of jewellery design enhanced by cutting-edge
                  GAN
                  <br /> technology, transforming low-quality images into
                  stunning, high-resolution
                  <br /> masterpieces.
                </p>
                <button
                  className="Get_Started mt-3 shadow"
            ...
            <div className="row" style={{ width: "100%" }}>
              <div className="key_features_container_headings col-12">
                ...
                <p className="text-center">
                  Enhance your jewellery designs effortlessly. Our tool uses
                  Deep Learning technology to create
                  <br />
            ...
            <div className="row" style={{ width: "100%" }}>
              ...
              <div className="col-12">
                <div className="faqs mt-5 mr-5 mb-3 pb-2" onClick={HandleFaq}>
                  ...
                  <div className="answer">
                    <p>
                      The process is near real-time for standard images.
                      However, very high-resolution images or complex
                      transformations may take a bit longer.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="faqs mt-3 mr-5 mb-3 pb-2" onClick={HandleFaq}>
                  ...
                  <div className="answer">
                    <p>
                      ...
                      image file to our platform, and the deep learning model
                      will automatically process and return a colorized version.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-12">
                <div className="faqs mt-3 mr-5 mb-3 pb-2" onClick={HandleFaq}>
                  ...
                  <div className="answer">
                    <p>
                      The accuracy of the colorization depends on the quality
                      and features of the sketch image. While the deep learning
                      model provides realistic color outputs, minor adjustments
                      may sometimes be needed for specific color tones. However,
                      the results are typically impressive and visually
                      appealing.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-12">
                <div className="faqs mt-3 mr-5 mb-3 pb-2" onClick={HandleFaq}>
                  <div className="question">
                    <h1>
                      How do you ensure the privacy of the uploaded images?
                    </h1>
                    <i className="fa-solid fa-chevron-right" />
                  </div>
                  <div className="answer">
                    <p>
                      ...
                      take privacy very seriously and adhere to best practices
                      in data protection.
                    </p>
                  </div>
                </div>
                ...
                <div className="faqs mt-3 mr-5 mb-3 pb-2" onClick={HandleFaq}>
                  ...
                  <div className="answer">
                    <p>
                      ...
                      datasets of colored images. The models learn how to
                      predict and generate realistic colors for black-and-white
                      images.
                    </p>
                  </div>
                </div>
        ...
        <div className="column">
          <div className="row" style={{ width: "100%" }}>
            ...
            <div className="links text-center col-12">
              ...
              <span
                style={{ borderRight: "1px solid white", marginRight: 40 }}
              />
